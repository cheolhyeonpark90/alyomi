...
const SEARCH_KEYWORDS = [
    "캐릭터", "산리오", "헬로키티", "마이멜로디", "쿠로미",
    "폼폼푸린", "포차코", "리틀트윈스타", "한교동", "배드바츠마루",
    "케로피", "마이 스위트 피아노", "위시미멜", "우사하나",
    "구데타마", "어그레츠코", "키리미짱", "하나마루오바케",
    "디즈니", "치이카와", "하치와레", "우사기", "농담곰",
    "모후산도", "포켓몬", "토토로", "리락쿠마", "카카오프렌즈",
    "춘식이", "라인프렌즈", "잔망루피", "미피", "무민", "스누피",
    "인형", "피규어", "도라에몽", "윌레스와 그로밋", "짱구"
];
